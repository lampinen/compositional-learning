...
gnuplot.plot({'standard',iterations,standard_track},{'standard (1st layer ReLU)',iterations,standard_ReLU_track},{'hierarchical',iterations,hierarchical_track},{'hierarchical (sloppy training)',iterations,hierarchical_sloppy_track})
...
gnuplot.plot({'standard',iterations,standard_MSE_track},{'standard (1st layer ReLU)',iterations,standard_ReLU_MSE_track},{'hierarchical',iterations,hierarchical_MSE_track},{'hierarchical (sloppy training)',iterations,hierarchical_sloppy_MSE_track})
